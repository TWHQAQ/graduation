...
<body
	...
	<div class="main">
		...
		<ul class="nav nav-tabs">
			...
			<li class="dropdown"><a class="dropdown-toggle"
				data-toggle="dropdown" href="../AccountManagement/AddAccount.jsp"> 账户 <span
					class="caret"></span>
			</a>
				<ul class="dropdown-menu">
	...
	<div class="panel panel-primary">
		...
		<div class="panel-body">
			<div class="login">
				<form class="form-horizontal" role="form" action="doChangeWord.jsp">
					...
					<div class="form-group">
						<label for="lastname" class="col-sm-2 control-label">输入新密码：</label>
						<div class="col-sm-4">
